        ...
        <div class="w-100 d-flex justify-content-center">
            <div class="d-flex flex-column gap-3 pt-5">
                ...
                <form action="konfirmasi-kontak.php" method="POST">
                    ...
                    <p class="fs-3">Hobby:</p>
                    <input type="checkbox" name="hobby[]" value="lari" id="lari" />
                    <label for="lari">Lari</label>
                    
                    <br />
                    
                    <input type="checkbox" name="hobby[]" value="loncat" id="loncat" />
                    <label for="loncat">Loncat</label>

                    <br />
                    
                    <input type="checkbox" name="hobby[]" value="renang" id="renang" />
                    <label for="renang">Renang</label>

                    <br />
                    <br />
                    
                    <p class="fs-3">Tanggal lahir:</p>
